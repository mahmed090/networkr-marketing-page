    ...
    >
      <div className="app-container">
        ...
        <div className="grid items-center gap-8 md:gap-12">
          <SectionTitle
            tagVariant="alert"
            tagIcon={<CircleAlert className="w-3.5 h-3.5" aria-hidden />}
            badge={coreProblem.badge}
            headline={coreProblem.headline}
            headlineItalic={coreProblem.headlineItalic}
            subtitle={coreProblem.subtitle}
          />
            ...
            {coreProblem.cards.map((card) => (
              ...
              >
                <div
                  ...
                  aria-hidden
                />
                <div className="p-4 md:p-8 rounded-3xl border border-border bg-background hover:border-border-strong transition-all duration-500 hover:shadow-2xl hover:shadow-gray-100/80 h-full">
                  ...
                  <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-medium text-primary mb-4 font-display">
                    {card.title}
                  </h3>
